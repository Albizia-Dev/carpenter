...
final class _CarpenterDropTargetWidgetState<T>
  ...
  CarpenterDropDetails<T>? _buildDetails(
    CarpenterDragTransport<T> transport,
    Offset avatarGlobalOffset,
  ) {
    final payload = transport.payload;
    final operation = _resolveOperation(payload);
    if (operation == null) return null;
    final pointerGlobalOffset = avatarGlobalOffset + transport.dragStartPoint;
    final localOffset = _localOffset(pointerGlobalOffset);
