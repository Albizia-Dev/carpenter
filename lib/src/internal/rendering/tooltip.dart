...
class ActionTooltip extends StatefulWidget {
  const ActionTooltip({
    super.key,
    required this.text,
    required this.child,
  ...
  @override
  State<ActionTooltip> createState() => _ActionTooltipState();
}

final class _ActionTooltipState extends State<ActionTooltip> {
