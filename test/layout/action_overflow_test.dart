...
void main() {
  test('overflow policy degrades whole action groups', () {
    ...
    expect(secondaryOverflow.stage, ActionOverflowStage.secondaryOverflow);
    ...
    expect(overflowOnly.overflow, ['primary', 'secondary-a', 'secondary-b']);
  });

  testWidgets(
    'action layout relocates as one block when inline space is gone',
    (tester) async {
